...
const AvailableCamp = () => {
    ...
    // const {_id, campName, image, campFees, date, time, location, healthcareProfessional, participantCount} = availableCamps;

    return (
        <div className="mt-28 bg-[#F5F5DC] py-10">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 container mx-auto">
                {
                    availableCamps?.map(camp => <div key={camp._id} className="w-full overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800">
